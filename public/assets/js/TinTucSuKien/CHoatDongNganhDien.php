...
class CHoatDongNganhDien extends BaseController
{
    public function index(): string
    {
        ...
        $baiviets = $baivietModel->getBaivietByDanhMucPaginated(202, $page, $perPage);
        $result =  $baivietModel->getTinMoiNhat($sobaiviet);
        $total = $baivietModel->where('iddanhmuc', 202)->countAllResults();
        $data = [
        ...
        return view('Client/TinTucSuKien/HoatDongNganhDien', $data);
    }
}