$(document).ready(function() {
    ...
    $('.Baiviet-xoa').click(function(event) {
        event.preventDefault(); // Ngăn chặn hành động mặc định của nút "Xóa"

        var idbaiviet = $(this).data('idbaiviet'); // Lấy id bài viết từ thuộc tính data-idbaiviet
        ...
        $('#confirmDeleteBtn').click(function() {
            $.ajax({
                type: 'DELETE',
                url: '/api/xoabaiviet/' + idbaiviet, // Đường dẫn đến phương thức xóa bài viết trong controller
