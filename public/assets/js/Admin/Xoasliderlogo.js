$(document).ready(function() {
    ...
    $('.sliderlogo-xoa').click(function(event) {
        event.preventDefault(); // Ngăn chặn hành động mặc định của nút "Xóa"
        var idsliderlogo = $(this).data('idsliderlogo'); // Lấy id bài viết từ thuộc tính data-idbaiviet
        ...
        $('#confirmDeleteBtn').click(function() {
            $.ajax({
                type: 'DELETE',
                url: '/api/xoasliderlogo/' + idsliderlogo, // Đường dẫn đến phương thức xóa bài viết trong controller
