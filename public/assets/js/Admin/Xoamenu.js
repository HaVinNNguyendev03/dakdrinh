$(document).ready(function() {
    ...
    $('.menu-xoa').click(function(event) {
        event.preventDefault(); // Ngăn chặn hành động mặc định của nút "Xóa"
        var idmenu = $(this).data('idmenu'); // Lấy id bài viết từ thuộc tính data-idbaiviet
        ...
        $('#confirmDeleteBtn').click(function() {
            $.ajax({
                type: 'DELETE',
                url: '/api/xoamenu/' + idmenu, // Đường dẫn đến phương thức xóa bài viết trong controller
