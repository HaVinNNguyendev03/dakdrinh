$(document).ready(function() {
    ...
    $('.thongtinduan-xoa').click(function(event) {
        event.preventDefault(); // Ngăn chặn hành động mặc định của nút "Xóa"

        var idthongtinduan = $(this).data('idthongtinduan'); // Lấy id bài viết từ thuộc tính data-idbaiviet
        ...
        $('#confirmDeleteBtn').click(function() {
            $.ajax({
                type: 'DELETE',
                url: '/api/deletedthongtinduan/' + idthongtinduan, // Đường dẫn đến phương thức xóa bài viết trong controller
