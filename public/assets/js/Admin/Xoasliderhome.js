$(document).ready(function() {
    ...
    $('.sliderhome-xoa').click(function(event) {
        event.preventDefault(); // Ngăn chặn hành động mặc định của nút "Xóa"

        var idsliderhome = $(this).data('idsliderhome'); // Lấy id bài viết từ thuộc tính data-idbaiviet
        ...
        $('#confirmDeleteBtn').click(function() {
            $.ajax({
                type: 'DELETE',
                url: '/api/xoasliderhome/' + idsliderhome, // Đường dẫn đến phương thức xóa bài viết trong controller
