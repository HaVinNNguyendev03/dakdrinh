$(document).ready(function() {
    ...
    $('.Video-xoa').click(function(event) {
        event.preventDefault(); // Ngăn chặn hành động mặc định của nút "Xóa"

        var idvideo = $(this).data('idvideo'); // Lấy id bài viết từ thuộc tính data-idbaiviet
        ...
        $('#confirmDeleteBtn').click(function() {
            $.ajax({
                type: 'DELETE',
                url: '/api/xoavideo/' + idvideo, // Đường dẫn đến phương thức xóa bài viết trong controller
