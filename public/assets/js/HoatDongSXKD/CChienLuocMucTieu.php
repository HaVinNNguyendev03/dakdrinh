...
class CChienLuocMucTieu extends BaseController
{
    public function index()
    {
        ...
        $baiviets = $baivietModel->getBaivietByDanhMucPaginated(301, $page, $perPage);
        $result =  $baivietModel->getTinMoiNhat($sobaiviet);
        $total = $baivietModel->where('iddanhmuc', 301)->countAllResults();
        $data = [
        ...
        return view('Client/HoatDongSKKD/chienluocmuctieu', $data);
    }
}
