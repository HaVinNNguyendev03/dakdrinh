...
class CNguoiLaoDong extends BaseController
{
    public function index()
    {
        ...
        $baiviets = $baivietModel->getBaivietByDanhMucPaginated(502, $page, $perPage);
        $result =  $baivietModel->getTinMoiNhat($sobaiviet);
        $total = $baivietModel->where('iddanhmuc', 502)->countAllResults();
        $data = [
...
$data['cauhinhweb'] = $cauhinhwebService->getAllCauhinhweb();
        return view('Client/AT-SK-MT/nguoilaodong', $data);
    }
}
