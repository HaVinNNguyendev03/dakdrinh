...
class CNganhNgheKinhDoanh extends BaseController
{
    public function index(): string
    {
        ...
        $baiviets = $baivietModel->getBaivietByDanhMucPaginated(102, $page, $perPage);
        $result =  $baivietModel->getTinMoiNhat($sobaiviet);
        $total = $baivietModel->where('iddanhmuc', 102)->countAllResults();
        $data = [
        ...
        return view('Client/GioiThieu/NganhNgheKinhDoanh', $data);
    }
}