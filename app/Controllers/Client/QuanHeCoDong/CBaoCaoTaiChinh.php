...
class CBaoCaoTaiChinh extends BaseController
{
    public function index()
    {
        ...
        $baiviets = $baivietModel->getBaivietByDanhMucPaginated(603, $page, $perPage);
        $result =  $baivietModel->getTinMoiNhat($sobaiviet);
        $total = $baivietModel->where('iddanhmuc', 603)->countAllResults();
        $data = [
        ...
        return view('Client/QuanHeCoDong/baocaotaichinh', $data);
    }
}
