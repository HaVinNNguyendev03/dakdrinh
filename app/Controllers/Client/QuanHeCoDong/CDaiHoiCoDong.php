...
class CDaiHoiCoDong extends BaseController
{
    public function index()
    {
        ...
        $baiviets = $baivietModel->getBaivietByDanhMucPaginated(602, $page, $perPage);
        $result =  $baivietModel->getTinMoiNhat($sobaiviet);
        $total = $baivietModel->where('iddanhmuc', 602)->countAllResults();
        $data = [
        ...
        return view('Client/QuanHeCoDong/daihoicodong', $data);
    }
}
