...
class CKeHoachSX extends BaseController
{
    public function index()
    {
        ...
        $baiviets = $baivietModel->getBaivietByDanhMucPaginated(303, $page, $perPage);
        $result =  $baivietModel->getTinMoiNhat($sobaiviet);
        $total = $baivietModel->where('iddanhmuc', 303)->countAllResults();
        $data = [
        ...
        return view('Client/HoatDongSKKD/kehoachsanxuat', $data);
    }
}
