...
<div class="col-12 wapper px-2 pt-2">
    <div class="wapper-content px-2 col-12 col-md-10 mx-auto">
        <div class="wapper-content-title">Quan Hệ Cổ Đông</div>
        <div class="wapper-content-tab">
            <ul class="tab-ul d-md-flex">
                <li class="my-4">
                    <a href="<?php echo base_url() ?>quanhecodong/thongtintailieu" data-toggle="tab">Thông Tin Tài Liệu Cổ Đông</a>
                </li>
                <li class="mx-md-4 my-4">   
                    <a href="<?php echo base_url() ?>quanhecodong/daihoicodong" data-toggle="tab">Đại Hội Cổ Đông</a>
                </li>
                <li class="mx-md-4 my-4">
                    <a href="<?php echo base_url() ?>quanhecodong/baocaotaichinh" data-toggle="tab">Báo Cáo Tài Chính Thường Niên</a>
                </li>
            </ul>
        </div>
    </div>
