    ...
    <div class="row g-0 g-xl-3 col-12 align-items-start">
        ...
        <div class="col-12 col-lg-8">
            <?php if (!empty($baiviet)): ?>
                <a class="card px-2 " href="<?= base_url('bai-viet/' . $baiviet[0]['tieudeurl'] . '/' . $baiviet[0]['idbaiviet']) ?>">
            ...
            <div class="card-content col-12 my-4 d-flex flex-wrap">
                <?php if (!empty($baiviet)): ?>
                    <?php foreach ($baiviet as $bv): ?>
                        <a class="card col-6 px-2 my-2" href="<?= base_url('bai-viet/' . $bv['tieudeurl'] . '/' . $bv['idbaiviet']) ?>">
