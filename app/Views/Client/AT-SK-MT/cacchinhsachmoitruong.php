...
<div class="col-12 wapper px-2 pt-2">
    <div class="wapper-content px-2 col-12 col-md-10 mx-auto">
        <div class="wapper-content-title">AT-SK-MT</div>
        <div class="wapper-content-tab">
            <ul class="tab-ul d-md-flex">
                <li class="my-4">
                    <a href="<?php echo base_url() ?>at-sk-mt/congdong" data-toggle="tab">Cộng Đồng</a>
                </li>
                <li class="mx-md-4 my-4">
                    <a href="<?php echo base_url() ?>at-sk-mt/nguoilaodong" data-toggle="tab">Người Lao Động</a>
                </li>
                <li class="mx-md-4 my-4">
                    <a href="<?php echo base_url() ?>at-sk-mt/chinhsach" data-toggle="tab">Các Chính Sách Môi Trường</a>
                </li>
            </ul>
        </div>
    </div>
