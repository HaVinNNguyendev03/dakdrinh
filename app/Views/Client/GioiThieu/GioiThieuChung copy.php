    ...
    <div class="wapper-content px-2 col-12 col-md-10 mx-auto">
        ...
        <div class="wapper-content-tab">
            <ul class="tab-ul d-md-flex">
                ...
                <li class="my-4">
                    <a href="<?= base_url() . $item['urldanhmuc'] . '/' . $item['iddanhmuc']; ?>" data-toggle="tab"><?= $item['tendanhmuc'] ?></a>
                </li>
                <?php endforeach ?>
            </ul>
        </div>
...
<td width="48%">
<p><strong>Cổ đông</strong></p>
</td>
<td width="22%">
<p><strong>Số cổ phần</strong></p>
</td>
<td width="22%">
<p><strong>Tỷ lệ sở hữu</strong></p>
</td>
</tr>
<tr>
<td width="6%">
...
<td width="22%"><strong>2.341.871.600</strong></td>
<td width="22%">
