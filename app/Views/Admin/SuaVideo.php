...
<?= $this->section('Admin'); ?>
<p style="display:none;" id="idvideo"><?= $video['idvideo'] ?></p>
            ...
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" enctype="multipart/form-data">
                        <div class="card-body">
                            <h4 class="card-title">Sửa Video</h4>
                        ...
                        <div class="border-top">
                            <div class="card-body text-end">
                                <button id="editvideo" type="button" class="btn btn-primary" onclick="submitFormEditVideo()">
                                    Sửa
                                </button>
                            </div>
                    </form>
