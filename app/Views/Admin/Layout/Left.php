            ...
            <ul id="sidebarnav" class="pt-4">
              <li class="sidebar-item">
                <a
                  ...
                  href="<?php echo base_url() ?>admin/trangchu"
                  aria-expanded="false"
              ...
              <li class="sidebar-item">
                <a
                  class="sidebar-link waves-effect waves-dark sidebar-link"
                  href="<?php echo base_url() ?>admin/bieudo"
                  aria-expanded="false"
                  ><i class="mdi mdi-chart-bar"></i
                  ><span class="hide-menu">Biểu Đồ Thủy Điện</span></a
                >
              </li>
              <!-- <li class="sidebar-item">
                <a
              ...
              <li class="sidebar-item">
                <a
                  ...
                  ><span class="hide-menu">Danh Mục Tin Tức </span></a>
                <ul id="left-sub" aria-expanded="false" class="collapse first-level">
                  <li class="sidebar-item">
                    <a href="<?php echo base_url() ?>admin/danhsachdangtin" class="sidebar-link"><i class="mdi mdi-note-outline"></i><span class="hide-menu">Tin Tức Đã Đăng</span></a>
                  </li>
                  <li class="sidebar-item">
                    <a href="<?php echo base_url() ?>admin/dangtin" class="sidebar-link"><i class="mdi mdi-note-plus"></i><span class="hide-menu">Đăng Tin</span></a>
                  </li>
                </ul>
              </li>
              <li class="sidebar-item">
