...
<?= $this->section('Admin'); ?>
<!-- Page wrapper  -->
<p style="display:none;" id="idslidertexthome"><?= $slidertexthome['idslidertexthome'] ?></p>
<!-- ============================================================== -->
                    ...
                    <form class="form-horizontal" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group row align-items-start">
                                ...
                                <div class="col-sm-9">
                                    <input name="textsliderhome" type="text" class="form-control" id="textsliderhome"
                        ...
                        <div class="border-top">
                            <div class="card-body text-end">
                                <button id="suanoidungslidertexthome" type="button" class="btn btn-primary" onclick="submitForm()">
                                    Sửa
                                </button>
                            </div>
                    </form>
