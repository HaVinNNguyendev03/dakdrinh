                    ...
                    <form class="form-horizontal" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-9">
                                    <input name="tieudethongtinduan" type="text" class="form-control" id="fname"
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            <div class="card-body " style="padding: 5px !important;">
                                                ...
                                                <textarea name="noidungthongtinduan" id="noidungthongtinduan" cols="30" rows="10"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="border-top">
                            <div class="card-body text-end">
                                <button id="dangduan" type="button" class="btn btn-primary" onclick="">
                                    Thêm
                                </button>
                            </div>
                    </form>
