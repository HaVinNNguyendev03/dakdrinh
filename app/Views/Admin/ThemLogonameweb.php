        ...
        <div class="card">
          <form class="form-horizontal" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-md-9">
                  <div class="custom-file">
                    <input name="anhlogo" type="file" class="custom-file-input" id="anhlogo" required
            ...
            <div class="form-group row">
              ...
              <div class="col-md-9">
                <div class="custom-file">
                  <input name="anhicon" type="file" class="custom-file-input" id="anhicon" required
                    style="border: 1px solid;" />
                </div>
              </div>
            </div>
            ...
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input name="linkemail" type="text" class="form-control" id="linkemail"
                  placeholder="First Name Here" />
              </div>
            </div>
            <div class="form-group row">
              ...
              <div class="col-sm-9">
                <input name="tenweb" type="text" class="form-control" id="tenweb"
                  placeholder="First Name Here" />
              </div>
            </div>
            <div class="border-top">
              <div class="card-body text-end">
                <button id="SuaSlogan" type="button" class="btn btn-primary" onclick="">
                  Sửa
                </button>
              </div>
          </form>
