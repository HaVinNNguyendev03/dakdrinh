...
<?= $this->section('Admin'); ?>
<!-- Page wrapper  -->
<p style="display:none;" id="idsliderhome"><?= $sliderhome['idsliderhome'] ?></p>
<!-- ============================================================== -->
            ...
            <div class="col-md-12">
                <div class="card">
                    <form class="form-horizontal" enctype="multipart/form-data">
                        <div class="card-body">
                            <h4 class="card-title">Sửa SliderHome</h4>
                        ...
                        <div class="border-top">
                            <div class="card-body text-end">
                                <button id="dangsliderhome" type="button" class="btn btn-primary" onclick="submitForm()">
                                    Sửa
                                </button>
                            </div>
                    </form>
